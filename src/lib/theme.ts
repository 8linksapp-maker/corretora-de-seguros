...
import seguros from '../data/themes/seguros.json';
...
export const PRESETS: Record<string, ThemePreset> = { dental, harmonizacao, vidro, seguros };
...
export function resolveTheme(): { vars: Record<string, string>; preset: ThemePreset } {
  const preset = PRESETS[themeConfig.preset] ?? PRESETS.seguros;
